...
# This file is the same as mass_reconstruction_mass_loss_narrow.py EXCEPT
# 	we are using the ttW instead of ttZ

# I don't want to rename everything in this file, so I am just changing it
# 	when we import the files.
...
with open("../data/mass_reco/mass_reco_input_narrow_selection_train_ttW.csv") as f:
...
with open("data/mass_reco/mass_reco_input_narrow_selection_btags_test_ttW.csv") as f:
...
with open("data/mass_reco/mass_reco_input_narrow_selection_btags_val_ttW.csv") as f:
