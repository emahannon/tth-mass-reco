...
class DataGenerator(keras.utils.Sequence):
	...
	def __data_generation(self, list_IDs_temp):
		...
		print("PRINTING ALL ORIGINAL FEATURE NAMES")
		print(feature_names)
		...
		# Note: if you change the number of features, you MUST retrain the scaler to fit the number of features and change the parameters of multiple functions from 61 to the reduced number of features
		# the good feature names variable has to state all the features you want to include, 
		# use the original feature list to include all features or remove features from that list as necessary
		# the original feature list is here: 'event id', 'top b px', 'top b py', 'top b pz', 'top b E', 'antitop b px', 'antitop b py', 'antitop b pz', 'antitop b E', 'top W px', 'top W py', 'top W pz', 'top W E', 'main lepton px', 'main lepton py', 'main lepton pz', 'main lepton E', 'antitop lepton px', 'antitop lepton py', 'antitop lepton pz', 'antitop lepton E', 'top W q1 px', 'top W q1 py', 'top W q1 pz', 'top W q1 E', 'top W q2 px', 'top W q2 py', 'top W q2 pz', 'top W q2 E', 'hadr tau px', 'hadr tau py', 'hadr tau pz', 'hadr tau E', 'top px', 'top py', 'top pz', 'top E', 'visible antitop px', 'visible antitop py', 'visible antitop pz', 'visible antitop E', 'visible main px', 'visible main py', 'visible main pz', 'visible main E', 'top b tag', 'anti top b tag', 'q1 tag', 'q2 tag', 'q1 and q2 delta R', 'hadr tau and main lep delta R', 'hadr tau and antitop lep delta R', 'anti top b and main lep delta R', 'anti top b and anti top lep delta R', 'top b and top w delta R', 'top and anti top delta R', 'met x', 'met y', 'Jets ET', 'num Jets 25', 'HT', 'lep tau decay type', 'num permutations'
		# below should be the original list
		good_feature_names = np.array(['event id', 'top b px', 'top b py', 'top b pz', 'top b E', 'antitop b px', 'antitop b py', 'antitop b pz', 'antitop b E', 'top W px', 'top W py', 'top W pz', 'top W E', 'main lepton px', 'main lepton py', 'main lepton pz', 'main lepton E', 'antitop lepton px', 'antitop lepton py', 'antitop lepton pz', 'antitop lepton E', 'top W q1 px', 'top W q1 py', 'top W q1 pz', 'top W q1 E', 'top W q2 px', 'top W q2 py', 'top W q2 pz', 'top W q2 E', 'hadr tau px', 'hadr tau py', 'hadr tau pz', 'hadr tau E', 'top px', 'top py', 'top pz', 'top E', 'visible antitop px', 'visible antitop py', 'visible antitop pz', 'visible antitop E', 'visible main px', 'visible main py', 'visible main pz', 'visible main E', 'top b tag', 'anti top b tag', 'q1 tag', 'q2 tag', 'q1 and q2 delta R', 'hadr tau and main lep delta R', 'hadr tau and antitop lep delta R', 'anti top b and main lep delta R', 'anti top b and anti top lep delta R', 'top b and top w delta R', 'top and anti top delta R', 'met x', 'met y', 'Jets ET', 'num Jets 25', 'HT', 'lep tau decay type', 'num permutations']) # removed HT

		# top 5 feature list: good_feature_names = np.array(['event id', 'top b pz', 'antitop b pz','visible antitop pz', 'hadr tau and antitop lep delta R', 'anti top b and main lep delta R', 'num permutations']) # removed HT

		indices = []

		for feature in good_feature_names:
			print(feature)
			print(feature_names_np)
			print("/n")
			# indices.append(np.where(feature_names_np != feature)[0][0])
			indices.append(np.where(feature == feature_names_np)[0][0])
		...
		print("PRINTING FEATURE_NAMES TYPE FOR COMPARISON")
		print(type(feature_names))
		feature_names = good_feature_names.tolist()
		print(type(feature_names))



		print(feature_names)
		print("/n printing X.shape ")
		print(X.shape)
		...
		if self.with_ids:
			...
			X = (X-self.scaler[0])/self.scaler[1]     # Standardize X=X, used when retraining scaler
			# X=X
		# print(X.shape)
		return X, y, weights
	def get_all(self):
...
# %%
# second parameter is 61,, 61 has to decrease by the number of features you are removing
# the second parameter should reflect the number of features
...
# %%
""" Init model. """
# the first parameter was originally 61,, again this should reflect the number of features
# so, we can calculate by subtracting the number of features we removed from 61
