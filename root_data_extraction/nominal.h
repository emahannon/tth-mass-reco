...
// Tue Feb 22 10:35:43 2022 by ROOT version 6.24/02
// from TTree nominal/nominal
// found on file: /mnt/c/Users/georg/CERN_data/truth/nominal/mc16a/p4416/410155.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/mnt/c/Users/georg/CERN_data/truth/nominal/mc16a/p4416/410155.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/mnt/c/Users/georg/CERN_data/truth/nominal/mc16a/p4416/410155.root");
      }
...
void nominal::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("HT_jetstauOR", &HT_jetstauOR, &b_HT_jetstauOR);
